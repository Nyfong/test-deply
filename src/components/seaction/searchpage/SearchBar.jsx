...
export function SearchBar({ onCategorySelect }) {
  const categoryMap = {
  ...
  const handleCategoryClick = (category) => {
    ...
    if (onCategorySelect) onCategorySelect(category); // Call the parent's category select handler
  };
      ...
      <form className="max-w-lg w-full">
        <div className="flex relative">
          ...
          >
            ...
            {/* Show "Please Select" if no category is selected */}
            <svg
