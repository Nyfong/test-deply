...
export function RatingReview() {
  return (
    <Rating>
      <RatingStar />
      <p className="ml-2 text-[10px] md:text-subheader font-bold text-gray-900 dark:text-white">
        4.95
      </p>
      <span className="mx-1.5 h-1 w-1 rounded-full bg-gray-500 dark:bg-gray-400" />
      <a
        href="#"
        className="text-[10px] md:text-subheader font-medium text-gray-900 underline hover:no-underline dark:text-white"
      >
        73 reviews
      </a>
    </Rating>
